...
export class AdminProductsComponent implements OnInit {
  ...
  loadProducts(): void {
    this.http.get<ApiResponse<any[]>>(`${environment.apiUrl}/products`)
      .subscribe({
        next: (apiResponse) => {
  ...
  openEditModal(product: Product): void {
    ...
    this.formData = {
      ...
      stockQuantity: this.getStock(product.id) || 0,
  ...
  saveProduct(): void {
    ...
    const payload = {
      ...
      stockQuantity: Number(this.formData.stockQuantity) || 0,
  ...
  deleteProduct(id: string): void {
    ...
    this.http.delete<ApiResponse<string>>(`${environment.apiUrl}/products/${id}`).subscribe({
